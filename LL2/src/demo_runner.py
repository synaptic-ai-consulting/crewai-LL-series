...
def run_demo():
    ...
    print("🎯 Lightning Lesson 2: Advanced Agent Persona Architecture")
    print("=" * 60)
    ...
    print("\nKey Takeaways:")
    print("• Persona-engineered agents show consistent brand voice")
    print("• Custom prompts enable professional differentiation")
    print("• Context adaptation improves collaboration")
